...
var mailOptions = {
  ...
  text: req.body.body
  html: '<h1>Reply to you ad you posted on myafrihub</h1><p>Do not reply to this mail directly</p><p>Poster: <%=post.poster%></p> <p>Repl to: <%=post.email%> </p> <p>Copyright &copy; BlueTech 2018. All Rights Reserved.</p>'
};
